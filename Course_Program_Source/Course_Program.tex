...
Afternoon II                   & Linear Modelling             & \begin{verbatim} 2_Linear_Modelling.R \end{verbatim} \\ \hline % Practise run took 1hrs 50min but I didn't explain the 'rgl' stuff in so that could easily fill the remaining time 
2.5hrs                         &                              &  \\ \hline
